...
public class MapedFile {
	...
	private final long fileSize = 1024 ;// 1M
	...
	public MapedFile() throws IOException {
		...
		this.fileChannel = new RandomAccessFile(this.FILE_NAME, "rw").getChannel();
	...
	public static void main(String[] a) throws IOException {
		...
		mappedFile.test_slic_写和读("hahahahahahaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
		System.out.println(mappedFile.file.length());
