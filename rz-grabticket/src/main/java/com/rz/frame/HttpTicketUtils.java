...
public class HttpTicketUtils {
	...
	private static BasicCookieStore getBasicCookieStore() {
		...
		BasicClientCookie expCookie = new BasicClientCookie("RAIL_EXPIRATION", "1577452454504");
		expCookie.setDomain("kyfw.12306.cn");
		expCookie.setPath("/");
		basicCookieStore.addCookie(expCookie);
		
		BasicClientCookie dfCookie = new BasicClientCookie("RAIL_DEVICEID", "Wo-yQc9u9YVQN6qFHVXH1zpvD5WUNTOv4YzMVrkP8bl2MCOoYy7Frhi4FIjf1dwRC9nKOx_eZ8v4uvgFcuHHxupAiqC_MsIe_pFxURxkndNN22S3jGFY0iuHvDOtaUvqb1Bc9t2XlrWEhcyxPVDevYM_vpKxmdMm");
